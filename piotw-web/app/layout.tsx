...
export default function RootLayout({children}:{children:React.ReactNode}) { return <html lang="en" data-scroll-behavior="smooth"><body><SiteHeader/><main>{children}</main><footer className="site-footer"><span><i className="brand-bars" aria-hidden><b/><b/><b/></i> PUT IT ON THE WALL</span><span>Outside-in operational intelligence · Development interface</span></footer></body></html>; }
